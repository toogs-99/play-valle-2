...
export default function FolderCard({
  ...
  return (
    ...
    >
      ...
      {/* Dynamic Label showing the Ata details as requested */}
      <div className="mt-4 text-center">
        <p className="text-sm font-bold text-slate-800 tracking-tight group-hover:text-indigo-600 transition-colors">
          {number}
        </p>
      </div>
    </section>
